public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Денис теперь получает " + DenisGn + " рублей. Годовой доход вырос на "+ GeneralGnDenis +" рублей");
        System.out.println("Кристина теперь получает " + KristinaGn + " рублей. Годовой доход вырос на "+ GeneralGnKristina +" рублей");
